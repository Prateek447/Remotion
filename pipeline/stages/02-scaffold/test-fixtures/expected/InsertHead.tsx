...
const steps: SceneStep[] = [
  ...
  // Edge case: empty list
  {
    ...
    snapshot: {
      nodes: [
        { id: "e1", value: 1, highlight: "new" },
      ],
      pointers: [
        { label: "head", targetNodeId: "e1", color: HEAD_COLOR },
      ],
      arrows: [],
    },
  },
