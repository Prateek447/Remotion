...
export const verticalOrderNarration: SceneNarration = {
  sceneId: "vertical-order",
  lines: [
...
export const verticalOrderDurations: NarrationDuration[] = [
  { step: 0,  duration: 17.8,  frames: 534 },
  { step: 1,  duration: 16.12, frames: 484 },
  { step: 2,  duration: 3.8,   frames: 114 },
  { step: 3,  duration: 23.36, frames: 701 },
  { step: 4,  duration: 16.64, frames: 500 },
  { step: 5,  duration: 11.72, frames: 352 },
  { step: 6,  duration: 6.08,  frames: 183 },
  { step: 7,  duration: 13.88, frames: 417 },
  { step: 8,  duration: 15.92, frames: 478 },
  { step: 9,  duration: 5.0,   frames: 150 },
  { step: 10, duration: 23.8,  frames: 714 },
  { step: 11, duration: 4.32,  frames: 130 },
  { step: 12, duration: 12.72, frames: 382 },
  { step: 13, duration: 18.12, frames: 544 },
  { step: 14, duration: 17.88, frames: 537 },
];

export const zigzagNarration: SceneNarration = {
  sceneId: "zigzag",
  lines: [
...
export const zigzagDurations: NarrationDuration[] = [
  { step: 0,  duration: 18.84, frames: 566 },
  { step: 1,  duration: 11.28, frames: 339 },
  { step: 2,  duration: 3.28,  frames: 99  },
  { step: 3,  duration: 7.76,  frames: 233 },
  { step: 4,  duration: 8.2,   frames: 246 },
  { step: 5,  duration: 6.08,  frames: 183 },
  { step: 6,  duration: 3.36,  frames: 101 },
  { step: 7,  duration: 5.08,  frames: 153 },
  { step: 8,  duration: 8.36,  frames: 251 },
  { step: 9,  duration: 5.36,  frames: 161 },
  { step: 10, duration: 2.56,  frames: 77  },
  { step: 11, duration: 11.12, frames: 334 },
  { step: 12, duration: 2.76,  frames: 83  },
  { step: 13, duration: 7.36,  frames: 221 },
  { step: 14, duration: 10.8,  frames: 324 },
  { step: 15, duration: 8.04,  frames: 242 },
  { step: 16, duration: 10.68, frames: 321 },
];

export const countTreeNodesDurations: NarrationDuration[] = [
  { step: 0, duration: 7.2, frames: 216 },
  { step: 1, duration: 7.86, frames: 236 },
  { step: 2, duration: 10.76, frames: 323 },
  { step: 3, duration: 3.76, frames: 113 },
  { step: 4, duration: 6.08, frames: 183 },
  { step: 5, duration: 3.96, frames: 119 },
  { step: 6, duration: 9.42, frames: 283 },
  { step: 7, duration: 6.3, frames: 189 },
  { step: 8, duration: 6.64, frames: 200 },
  { step: 9, duration: 6.74, frames: 203 },
  { step: 10, duration: 6.62, frames: 199 },
  { step: 11, duration: 6.08, frames: 183 },
  { step: 12, duration: 6.64, frames: 200 },
  { step: 13, duration: 9.12, frames: 274 },
  { step: 14, duration: 5.94, frames: 179 },
  { step: 15, duration: 3.56, frames: 107 },
  { step: 16, duration: 5.74, frames: 173 },
  { step: 17, duration: 4.92, frames: 148 },
  { step: 18, duration: 6.8, frames: 204 },
  { step: 19, duration: 6.38, frames: 192 },
  { step: 20, duration: 5.7, frames: 171 },
  { step: 21, duration: 4.8, frames: 144 },
  { step: 22, duration: 6.76, frames: 203 },
  { step: 23, duration: 8.44, frames: 254 },
  { step: 24, duration: 9.68, frames: 291 },
  { step: 25, duration: 7.8, frames: 234 },
];
