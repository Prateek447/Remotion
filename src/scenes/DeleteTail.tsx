...
const steps: SceneStep[] = [
  ...
  // Found predecessor — n9 active, n5 removing
  {
    startFrame: 801,
...
export const DELETE_TAIL_SCENE_FRAMES = 1185;

const REEL_SAFE: SafeArea = { top: 150, bottom: 380, left: 60, right: 160 };
const REEL_TOP_RATIO = 0.42;

export interface DeleteTailProps {
  tokens: ThemedToken[][];
  format?: "youtube" | "reel" | "reel-anim";
}

export const DeleteTail: React.FC<DeleteTailProps> = ({ tokens, format = "youtube" }) => {
  ...
  return (
    <>
      ...
      {!isAnim && <NarrationLayer sceneId="delete-tail" steps={activeSteps} />}
    </>
  );
};
